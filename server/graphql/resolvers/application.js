...
// Private
const addApplicationItems = async (args, req) => {
  try {
    if (loggedin(req)) {
...
// Private
const getApplicationById = async (args, req) => {
  try {
    if (loggedin(req)) {
...
// Private/Admin
const updateApplicationToReturned = async (args, req) => {
  try {
    if (admin(req)) {
...
// Private
const getMyApplications = async (args, req) => {
  try {
    if (loggedin(req)) {
...
// Private/Admin
const getApplications = async (args, req) => {
  try {
    if (admin(req)) {
